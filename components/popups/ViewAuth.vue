  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <div class="head-info">
          <a href="javascript:void(0)" class="register"><span>Log in to continue</span></a>
          <a href="javascript:void(0)" class="login" @click="showPopup">Not a memver yet? <span>Register now</span></a>
        </div>
        <form class="main-form">
          <label class="form-element">
            <div class="field-name">login</div>
            <input class="form-field" type="text" name="Login" v-model="login">
          </label>
          <label class="form-element">
          ...
          <label class="checkbox-button">
            <input type="checkbox" name="remember-me" v-model="remember" value="Y">
            <span class="checkmark"></span>
            <p>Keep me logged in</p>
          </label>
          <button class="btn" @click="sendLogin" type="button">Log in</button>
        </form>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    async sendLogin(event){
      ...
      formData.append('USER_LOGIN', this.login)
      formData.append('USER_PASSWORD', this.password)
      formData.append('mode', 'authorize')
