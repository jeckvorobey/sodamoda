    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="head-info single">
          <div><span>Enter the code from the message</span></div>
          <div>We have sent a confirmation code to your email address, enter this code in the field below to reset your old password</div>
        </div>
        <form class="main-form single">
          <label class="form-element">
            <div class="field-name">code</div>
            <input class="form-field" type="text" name="code">
          </label>
