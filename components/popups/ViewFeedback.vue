    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="head-info">
          ...
          <a href="#" class="login" @click="showPopup">Not a memver yet? <span>Register now</span></a>
        </div>
        <form class="main-form">
          ...
          <button class="btn" @click="sendLogin">Log in</button>
        </form>
      </div>
    </div>
  </div>
...
export default {
  ...
  computed:{
    loginData(){
      return this.$store.getters["popup/loginData"]
    },
  },
  methods: {
    showPopup(){
    ...
    async sendLogin(event){
      ...
      for(let key of this.loginData.fields){
        switch (key.name){
          case 'USER_LOGIN':
            formData.append(key.name, this.login)
            break;
          case 'USER_PASSWORD':
            formData.append(key.name, this.login)
            break;
      ...
      formData.append('mode', this.loginData.form.mode)
